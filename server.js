...
function startServer(port){
  if (program.allowRemote) console.log('Warning! qredit-rpc allows remote connections, this is potentially insecure!');
  ...
  server = restify.createServer().
    ...
    server.listen(port, function() {
      console.log('qredit-rpc listening at %s', server.url);
    });
}
